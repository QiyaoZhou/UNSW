...
count1 = CountVectorizer(lowercase=True,token_pattern='[-/$%\da-zA-Z\w]{2,}', max_features=1000, stop_words='english')
...
model_1 = clf1.fit(X_train_bag_of_words1, train_sentiment)

count2 = CountVectorizer(lowercase=True,token_pattern='[-/$%\da-zA-Z\w]{2,}', stop_words='english')
...
clf2 = BernoulliNB()
model_2 = clf2.fit(X_train_bag_of_words2, train_sentiment)

clf3 = MultinomialNB()
model_3 = clf3.fit(X_train_bag_of_words2, train_sentiment)
