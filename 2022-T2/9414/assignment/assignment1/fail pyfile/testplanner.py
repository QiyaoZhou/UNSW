...
input_file = 'D:/UNSW/2022-T2/9414/assignment/assignment1/input2.txt'
...
start_time = 0  # assume we have a timeline, start at mon 00:00
Cost = {}  # cost information for soft domain
time_list = []  # all the available timetable
...
solution = Con_solver(fuzzyScheduler).make_arc_consistent()
print(solution)
