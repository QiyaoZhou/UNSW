...
import Yolov5_Deepsort.tracker as tracker
def create_deepsort(cfg):
...
def run(
    ...
    deepsort = create_deepsort(deepsort_cfg)
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        print(f"len(xywhs):{len(xywhs)}, len(outputs):{len(outputs)}")
...
if __name__ == "__main__":
    ...
    opt.source = "assets/"
    opt.source = "datasets/step_images/train/STEP-ICCV21-02"
